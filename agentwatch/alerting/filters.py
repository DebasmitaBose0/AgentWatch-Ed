...
def default_filter(event: AgentEvent) -> bool:
    """Return True if the event is deemed safe and doesn't need immediate paging."""
    if event.safety and event.safety.blocked:
        return False
    return True
